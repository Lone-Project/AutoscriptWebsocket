...
cat> /usr/local/etc/xray/$user-celcom.json << EOF
      ...
      "aid": "0",
      "net": "ws",
      "path": "wss://onlinepayment.celcom.com.my/vmessws",
      "type": "none",
      "host": "${domain}",
      "tls": "tls",
...
mv /usr/local/etc/xray/$user-VMMCELCOM.yaml /home/vps/public_html/$user-VMCELCOM.yaml
clear
echo -e ""
...
echo -e "════════════════════════════════════════"
echo -e "YAML (CELCOM)     : http://${domain}:81/$user-VMCELCOM.yaml"
echo -e "════════════════════════════════════════"

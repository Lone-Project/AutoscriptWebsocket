...
cat > /usr/local/etc/xray/$user-VLCELCOM.yaml <<EOF
port: 7890
socks-port: 7891
redir-port: 7892
mixed-port: 7893
...
proxies:
  - name: XRAY_VLESS_CELCOM_${user}
    ...
    network: ws
    ws-opts:
      path: wss://onlinepayment.celcom.com.my/vlessws
      headers:
        Host: ${host}
    udp: true
proxy-groups:
...
mv /usr/local/etc/xray/$user-VLCELCOM.yaml /home/vps/public_html/$user-VLCELCOM.yaml
clear
echo -e ""
